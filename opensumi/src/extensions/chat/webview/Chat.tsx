...
export const Chat: React.FC = () => {
  ...
  // 直接用 opencode SDK (chat 是 opencode 闭环拓展, 不走 IAIService 抽象)
  const client = (window as any).__ANIMBOOK_OPENCODE__;
  const isReady = () => !!client && !!(window as any).__ANIMBOOK_FS_API__?.getWorkspaceDirSync?.();
  useEffect(() => {
