/**
 * FS 服务 — services/fs.ts
 *
 * IDE 相对路径 ↔ 宿主机绝对路径的语义层. 上层 (pdf / editor / runtime 钩子) 只调这些.
 *
 * 通道分布:
 ...
 *   - find  : PTY shell
 *
 * shell 平台感知走 services/shell.ts (Windows → PowerShell, 其余 → /bin/sh).
 */

import { getOpencodeClient } from './opencode-sdk';
